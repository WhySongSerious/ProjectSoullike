...
namespace ProjectSoullike.Editor
{
    public static class SoullikePlayerWeaponSetup
    {
        ...
        private const string SwordPrefabPath = "Assets/ThirdParty/TC_Sword/TonySword_01.fbx";
        private const string BladeMaterialPath = "Assets/ThirdParty/TC_Sword/Materials/Refelection_03.mat";
        private const string HandleMaterialPath = "Assets/ThirdParty/TC_Sword/Materials/phongE1Handle.mat";
        private const string HiltMaterialPath = "Assets/ThirdParty/TC_Sword/Materials/phongE2Hilt.mat";
