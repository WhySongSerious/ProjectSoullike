...
namespace ProjectSoullike.Editor
{
    public static class SoullikePlayerComboSetup
    {
        ...
        private const string AttackFbxPath =
            "Assets/TC_Sword/Animation/KBS_Sword_ATK_Combo_01_001_IP.fbx";
        private const string IdlePath = "Assets/TC_Sword/Animation/KBS_Ready_Idle_001.fbx";
        private const string WalkPath = "Assets/TC_Sword/Animation/KBS_Walk_F_001_IP.fbx";
        private const string RunPath = "Assets/TC_Sword/Animation/KBS_Run_F_001_IP.fbx";
            ...
            AnimationClip attackThree)
        {
            ...
            CreateRecoveryState(
                stateMachine, "Recovery 1", attackOne, new Vector3(700f, 20f));
            CreateRecoveryState(
                stateMachine, "Recovery 2", attackTwo, new Vector3(900f, 100f));
        ...
        private static AnimatorState CreateRecoveryState(
            AnimatorStateMachine stateMachine,
            string name,
            AnimationClip clip,
            Vector3 position)
