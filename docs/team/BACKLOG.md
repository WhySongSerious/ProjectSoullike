...
| RC | S7 | P0 | 천지민 | 3 | [#15 ML 포함 릴리스 후보 빌드·성능·회귀 검증](https://github.com/WhySongSerious/ProjectSoullike/issues/15) | #12, #13, #14, #26 |
| POLISH | S8 | P0 | 송재혁 | 3 | [#16 최종 전투 연출·빌드 안정화](https://github.com/WhySongSerious/ProjectSoullike/issues/16) | #15 |
| REGRESS | S8 | P0 | 천지민 | 3 | [#17 전투·시연 차단 오류 수정 및 재검증](https://github.com/WhySongSerious/ProjectSoullike/issues/17) | #15 |
| DEMO | S8 | P0 | 이다윤 | 3 | [#18 시연 대본·최종 QA·알려진 문제 정리](https://github.com/WhySongSerious/ProjectSoullike/issues/18) | #15, #27 |
| RELEASE | 마감 | P0 | 송재혁 | 2 | [#19 11/23 ML 동적 난이도 포함 최종 납품](https://github.com/WhySongSerious/ProjectSoullike/issues/19) | #16, #17, #18, #27 |
| OPTION | BACKLOG | P2 | 천지민 | 3 | [#20 가드·패링 후속 범위 검토](https://github.com/WhySongSerious/ProjectSoullike/issues/20) | #15 |

| DATA_SPEC | S3 | P0 | 이다윤 | 3 | [#21 ML 데이터·라벨·평가 기준 정의](https://github.com/WhySongSerious/ProjectSoullike/issues/21) | #4, #11 |
| TELEMETRY | S4 | P0 | 송재혁 | 5 | [#22 ML 학습용 전투 데이터 수집 파이프라인 구현](https://github.com/WhySongSerious/ProjectSoullike/issues/22) | #9, #10, #21 |
| COLLECT | S5 | P0 | 이다윤 | 3 | [#23 학습 데이터 수집 운영·라벨링·품질 점검](https://github.com/WhySongSerious/ProjectSoullike/issues/23) | #22 |
| TRAIN | S6 | P0 | 송재혁 | 5 | [#24 데이터 기반 동적 난이도 모델 학습·오프라인 평가](https://github.com/WhySongSerious/ProjectSoullike/issues/24) | #22, #23 |
| BOSS_ADAPTER | S5 | P0 | 천지민 | 3 | [#25 ML 난이도 출력용 보스 조절 인터페이스 구현](https://github.com/WhySongSerious/ProjectSoullike/issues/25) | #13, #21 |
