...
**2026-11-23까지 ML 기반 동적 난이도 포함 데모 완성.** 송재혁이 데이터 수집 구조·학습·추론 적용의 주 책임을 맡습니다. 천지민은 보스 조절/연동·검증, 이다윤은 데이터/라벨 기준·수집 운영·평가를 지원합니다. 휴대폰 컨트롤러는 필수 완료 후 시간 여유 시 진행합니다.
