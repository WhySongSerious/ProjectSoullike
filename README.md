...
Unity 6 기반 3D 소울라이크 전투 프로토타입입니다. **송재혁·천지민·이다윤 3명이 11월 초까지 플레이 가능한 전투 데모를 완성**합니다.

> 개발 코드 기준: **`codex/initial-content`** · 코드 확인 기준 커밋: `d8d4a43`
> 현재 `main`은 팀 안내 진입점입니다. 게임 실행은 아래 명령으로 개발 브랜치를 받으세요.
> 목표일 **2026-11-06은 “11월 초”를 구체화한 제안값**이며, 첫 계획 회의에서 확정합니다.
...
| 팀원 | 주 담당 | 주간 결과물 |
| --- | --- | --- |
| 송재혁 · 팀장 | 우선순위·통합·플레이어 전투·VFX·애니메이션 | 실행 빌드, 전투 흐름, 핵심 연출 |
| 천지민 | 보스 AI·패턴·공격 판정·전투 안정화 | 골렘 전투, 예외 처리, 오류 수정 |
| 이다윤 | 기획 및 아트·UI 방향·밸런스·플레이테스트 | 패턴/수치 명세, 리소스, 테스트 결과 |
...
- **후순위:** 가드·패링·적응형 난이도는 필수 품질을 확보한 뒤 선택합니다.
...
| 남은 필수 | 회피·스태미나·피격 연출·보스 전용 모션·재시작/승리 흐름·검수 |
